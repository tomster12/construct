...
public class Construct : MonoBehaviour
{
    ...
    private HashSet<ConstructObject> trackedObjects = new HashSet<ConstructObject>();
    ...
    ConstructObjectMovement currentMovement = null;
    ...
    public void TrackObject(ConstructObject trackedCO) => trackedObjects.Add(trackedCO);

    public void UntrackObject(ConstructObject trackedCO) => trackedObjects.Remove(trackedCO);
